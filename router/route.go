...
import (
	...
	"community-go/config"
	"community-go/controller/article"
	"community-go/controller/baidu"
	"community-go/controller/book"
	"community-go/controller/category"
	"community-go/controller/collect"
	"community-go/controller/comment"
	"community-go/controller/common"
	"community-go/controller/crawler"
	"community-go/controller/keyvalueconfig"
	"community-go/controller/message"
	"community-go/controller/stats"
	"community-go/controller/user"
	"community-go/controller/vote"
